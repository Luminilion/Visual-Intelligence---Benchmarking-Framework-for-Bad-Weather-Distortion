...
from model import DeRain_v2  #DeRain_v1
...
if __name__ == '__main__':
    ...
    val_filename = "SIRR_test.txt" #"real_input_split1.txt" #"SIRR_test.txt" #'val_list_SIRR.txt'
    val_data_loader = DataLoader(ValData(val_data_dir,val_filename), batch_size=val_batch_size, shuffle=False, num_workers=8)#24)
